...
then
	...
	./emu --shva '127.0.0.1:7887' --out '127.0.0.1:9779' --in '127.0.0.1:3748' --inum 18 --log 7  --config pepa_with_tickets.config --emuin 4 --emusleep 1000000 --emubufmin 120 --emubuf 1024 --color
