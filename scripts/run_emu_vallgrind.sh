...
valgrind --leak-check=full ./emu --shva '127.0.0.1:7887' --out '127.0.0.1:9779' --in '127.0.0.1:3748' --inum 18 --log 7  --config pepa.config --emuin 4 --emubuf 20480 --emubufmin 32 --color
