...
#if 0 /* SEB */
	case PEPA_ERR_EVENT:
		return "PEPA_ERR_EVENT: And event received on event fd desciptor";
	case PEPA_ERR_STOP:
		return "PEPA_ERR_STOP: Thread must stop and terminate";

		/* Situative statuses */
	case PEPA_ERR_THREAD_SHVA_DOWN:
		return "PEPA_ERR_THREAD_SHVA_DOWN: SHVA thread is in DOWN state";
	case PEPA_ERR_THREAD_SHVA_FAIL:
		return "PEPA_ERR_THREAD_SHVA_FAIL: SHVA thread is in FAIL state";
	case PEPA_ERR_THREAD_IN_FAIL:
		return "PEPA_ERR_THREAD_IN_FAIL: IN thread is in FAIL state";
	case PEPA_ERR_THREAD_IN_DOWN:
		return "PEPA_ERR_THREAD_IN_DOWN: IN thread is in DOWN state";
	case PEPA_ERR_THREAD_IN_SOCKET_RESET:
		return "PEPA_ERR_THREAD_IN_SOCKET_RESET: IN thread should reset listening socket";
	case PEPA_ERR_THREAD_OUT_DOWN:
		return "PEPA_ERR_THREAD_OUT_DOWN: OUT thread is in DOWN state";
	case PEPA_ERR_THREAD_OUT_FAIL:
		return "PEPA_ERR_THREAD_OUT_FAIL: OUT thread is in FAIL state";

		/* Memory related errors */
	case PEPA_ERR_NULL_POINTER:
		return "PEPA_ERR_NULL_POINTER: An argument is NULL pointer";
#endif	
...
#if 0 /* SEB */
	case PEPA_ERR_SOCKET_CLOSE:
		return "PEPA_ERR_SOCKET_CLOSE: Can not close the socket";
	case PEPA_ERR_CANNOT_SHUTDOWN:
		return "PEPA_ERR_CANNOT_SHUTDOWN: Can not shotdown() a listening socket";

		/* Data transfer */
	case PEPA_ERR_SELECT_EXCEPTION_LEFT:
		return "PEPA_ERR_SELECT_EXCEPTION_LEFT: An exception happened on 'left' file descriptor";
	case PEPA_ERR_SELECT_EXCEPTION_RIGHT:
		return "PEPA_ERR_SELECT_EXCEPTION_RIGHT: An exception happened on 'right' file descriptor";
	case PEPA_ERR_SELECT_ABNORMAL:
		return "PEPA_ERR_SELECT_ABNORMAL: select() call finished with an error";
	case PEPA_ERR_SOCKET_READ:
		return "PEPA_ERR_SOCKET_READ: Data transfer between sockets finished with an error";
#endif	
...
#if 0 /* SEB */
	case PEPA_ERR_SOCKET_READ_CLOSED:
		return "PEPA_ERR_SOCKET_READ_CLOSED: Socked closed when tried to read from";
	case PEPA_ERR_SOCKET_WRITE:
		return "PEPA_ERR_SOCKET_WRITE: Socket closed when tried to write to";
	case PEPA_ERR_SOCKET_WRITE_CLOSED:
		return "PEPA_ERR_SOCKET_WRITE_CLOSED: Right socked closed when tried to write to";
#endif	
